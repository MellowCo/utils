...
describe('date', () => {
  it('formatDate', () => {
    ...
    expect(formatDate('', FormatType.toDay)).toMatchInlineSnapshot('"2022-08-14"')
    expect(formatDate(now, FormatType.toDay)).toMatchInlineSnapshot('"2022-08-14"')
  })
  ...
  it('addDays', () => {
    expect(addDays(1)).toMatchInlineSnapshot('"2022-08-15"')
