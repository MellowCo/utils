...
describe('date', () => {
  ...
  it('getFirstDayOfMonth', () => {
    ...
    expect(getFirstDayOfMonth({ format: dateFormatTag.toSecond })).toMatchInlineSnapshot('"2022-08-01 00:00:00"')
    ...
    expect(getFirstDayOfMonth({ year: 2021 })).toMatchInlineSnapshot('"2021-08-01"')
